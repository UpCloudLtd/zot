...
// Close releases the connections this sink pooled. Each sink owns a cloned
// transport, so one replaced by a config reload holds its keep-alive
// connections open until they are dropped here.
