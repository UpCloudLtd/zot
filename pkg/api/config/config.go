...
// EventsFingerprint returns a stable SHA-256 of the events extension config. A reload
// compares it to decide whether the recorder has to be rebuilt: its sinks are live
// connections, so an unrelated config change must not tear them down.
